...
const Navbar = () => (
  <header className="sticky top-0 z-50 w-full bg-background-light/80 dark:bg-navbar-color/80 backdrop-blur-sm">
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex h-16 items-center justify-between">
        ...
        <nav className="hidden items-center gap-8 md:flex">
          <a className="text-sm font-medium transition-colors hover:text-primary" href="#">Services</a>
          <a className="text-sm font-medium transition-colors hover:text-primary" href="#">About Us</a>
          <a className="text-sm font-medium transition-colors hover:text-primary" href="#">Contact</a>
        </nav>
