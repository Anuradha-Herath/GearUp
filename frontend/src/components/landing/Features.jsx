...
const serviceImageStyles = [
  ...
  { backgroundImage: 'url("https://images.unsplash.com/photo-1580273916550-e323be2ae537?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1964&q=80")' }, // Maintenance - car oil change
  { backgroundImage: 'url("https://images.unsplash.com/photo-1558618666-fcd25c85cd64?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80")' }, // AC Service - car air conditioning
];

const ServiceCard = ({ id, title, description, detailedDescription, style }) => (
  <div className="flex flex-col overflow-hidden rounded-lg bg-primary/10 dark:bg-primary/20 shadow-md border border-primary/20">
    <div className="aspect-video w-full bg-cover bg-center" style={style}></div>
    <div className="p-6">
      <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{title}</h3>
      <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">{description}</p>
      <p className="mt-3 text-sm text-gray-700 dark:text-gray-300">{detailedDescription}</p>
    </div>
  </div>
);
