...
const ManageEmployees = () => {
  ...
  const [confirmModal, setConfirmModal] = useState({ isOpen: false, employeeId: null, action: null });
  ...
  const toggleEmployeeStatus = async (id, currentStatus) => {
    try {
      ...
      console.log('Toggling employee status:', { id, currentStatus, newStatus });
  ...
  return (
    <div className="space-y-6">
                  ...
                  <tr key={employee.id} className="hover:bg-gray-50">
                    {editingEmployee === employee.id ? (
                      ...
                      <>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-500">{employee.phoneNumber || 'N/A'}</div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                            employee.isActive 
      ...
      <ConfirmationModal
        ...
        onCancel={() => setConfirmModal({ isOpen: false, employeeId: null, action: null })}
        confirmText="Delete"
        cancelText="Cancel"
        type="danger"
      />
